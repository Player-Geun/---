...
public class ApplicationContextSameBeanFindTest {
    ...
    void findBeanByTypeDuplicate() {
        ...
        assertThrows(NoUniqueBeanDefinitionException.class, () ->
                ac.getBean(MemberRepositroy.class));
    }
    ...
    void findBeanByName() {
        ...
        MemberRepositroy memberRepository = ac.getBean("memberRepository1", MemberRepositroy.class);

        assertThat(memberRepository).isInstanceOf(MemberRepositroy.class);
    }
    ...
    void findAllBeanByType() {
        ...
        Map<String, MemberRepositroy> beansOfType = ac.getBeansOfType(MemberRepositroy.class);
